...
//To show saved cities and user input
init();
...
// ---------------------Beginning of AJAX Call---------------------------
    $.ajax({
        ...
        fiveDayQueryURL = FiveDayQueryUrl();
...
function CurrentWeatherCardHist() {
    $(weatherCard).append(cityDateEl);
    $(weatherCard).append(weathericon)
    $(weatherCard).append(tempEl);
    $(weatherCard).append(humidityEl);
...
// Five Day Forecast ---------------------------------------------------------
        ...
        fiveDayQueryURL = FiveDayQueryUrlHist();
        $.ajax({
            url: fiveDayQueryURL,
            method: "GET"
        }).then(function (fiveData) {
